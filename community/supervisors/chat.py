...
from community.core.scoping import (
...
# 호출하는 코드 그대로 두되 community.core.scoping 의 함수를 alias 로 노출.
...
class ChatSupervisor(Supervisor):
    ...
    async def check(self, ctx):
        ...
        from community.core.scoping import is_quiet_hour, quiet_hour_label
        if is_quiet_hour():
            log_writer.system(
        ...
        from community.core.prompts.en.supervisor_judge import CHAT_STUCK_QUESTION
