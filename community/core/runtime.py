...
existing ``from community.core.runtime import runtime`` call sites keep working.
"""
...
from community.adapters.kernel_store import (
...
import community.core.memory  # noqa: F401,E402
...
def _app_leak_reporter(agent_id: str, channel_name: str, leaked_text: str, source: str):
    ...
    from community.core.dev_agent import enqueue_dev_request, find_similar_recent_request
...
def _app_profile_reminder(owner_profile: dict):
    ...
    from community.core.profile_anomalies import check_user_profile_anomalies, format_anomaly_hint
