...
class SupervisorPool:
    ...
    def _dump_snapshot(self):
        ...
        try:
            ...
            from community import db as _db, community as _comm
    ...
    async def _sync_scene_supervisors(self):
        ...
        try:
            from community.scenes import all_scenes
        except Exception:
            return
    ...
    async def _sync_channel_supervisors(self):
        ...
        try:
            from community.supervisors.chat import ChatSupervisor
        except Exception:
            return
    ...
    def register_system_supervisors(self):
        ...
        try:
            from community.supervisors.orchestrator import OrchestratorSupervisor
        ...
        try:
            from community.supervisors.dev_queue import DevQueueSupervisor
        ...
        try:
            from community.supervisors.commitment import CommitmentSupervisor
