...
from community.scenes.base import Scene, Phase, register_scene
from community.scenes.tutorial.prompts import (
    build_mgr_fragment,
...
class TutorialScene(Scene):
    ...
    def set_phase(self, phase_id: str):
        ...
        try:
            ...
            from community.supervisors.base import pool as _pool
    ...
    def supervisors(self) -> list:
        ...
        from community.scenes.tutorial.supervisor import TutorialFlowSupervisor
