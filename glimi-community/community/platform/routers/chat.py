...
side), imports the kernel via the discord-free shim ``community.core.runtime``, and
...
def _api_user(request: Request, community_id: str) -> Optional[dict]:
    ...
    from community import community as _community_mod
...
def _load_community_llm_env() -> None:
    ...
    the keys that matter, without importing ``community.bot`` (it pulls
    ``import discord``).
    ...
    """
    try:
        from community.core import monitor as _monitor
