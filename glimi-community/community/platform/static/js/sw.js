 ...
 *  - cache-first ONLY for same-origin static assets under /static/ (they are
 *    cache-busted by ?v=, so a cached hit is always the right version).
...
self.addEventListener('fetch', function (event) {
  ...
  // Versioned static assets → cache-first (the ?v= guarantees freshness).
