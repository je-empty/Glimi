...
async def cmd_create_agent(ctx, *, concept: str):
    ...
    from community.core.prompts.en.commands.create_agent import create_agent_prompt
...
async def cmd_avatar_prompt(ctx, agent_name: str):
    ...
    # 검증된 프롬프트 템플릿
    from community.core.prompts.en.external.image_gen import profile_image_prompt
...
async def cmd_analyze(ctx):
    ...
    from community.core.prompts.en.commands.analyze_logs import analyze_logs_prompt
