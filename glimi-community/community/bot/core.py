...
from community.core.profile import load_profile, list_all_profiles, get_user_name, get_user_id
from community.core.runtime import runtime
from community import db, log_writer, community
...
async def send_as_agent(channel: discord.TextChannel, agent_id: str, message: str, paced: bool = True):
    ...
    if paced:
        from community.bot.paced_sender import paced as _paced_sender
        async def _send_fn():
