...
from community.bot.conversation_bridge import (
...
async def yuna_approve_action(report_channel, args_str, guild):
    ...
    if action_type == "DM":
        ...
        from community.bot import internal_dm_channel_name, _norm_name_for_channel
...
async def _greet_new_persona(guild, agent_id, agent_name, dm_name):
    ...
    import asyncio as _aio
    from community.bot.core import _split_for_chat
    try:
        ...
        from community.core.profile import get_user_name, get_owner_call_name
...
async def handle_room_request_detection(
    ...
    if mgr_ch:
        # 유나가 판단해서 행동하도록 알림
        from community.core.prompts.en.mgr_notifications import room_request_notify_prompt
...
async def _apply_sample_profile_image(report_channel, args_str, guild, caller_agent_id: str = ""):
    ...
    try:
        from community.bot.core import update_agent_webhook_profile_image
        if guild:
            updated_chs = 0
...
async def _forward_action_to_yuna(agent_id: str, action_str: str, guild):
    ...
    from community.core.profile import get_owner_call_name as _get_oc
    from community.core.prompts.en.mgr_notifications import (
