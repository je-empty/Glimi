...
# 프롬프트 가이드(에이전트에 주입) 는 `src/core/formatting.py` 로 이동 — platform
# decoupling (코어가 bot 의존 못 하게). 하위 호환 위해 여기서 re-export.
from community.core.formatting import (  # noqa: E402,F401
    FORMATTING_GUIDE,
    get_formatting_guide,
)
