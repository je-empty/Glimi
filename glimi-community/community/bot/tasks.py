...
async def on_ready():
    ...
    try:
        from community.bot.tool_handlers import register_all as _register_tools
        _register_tools()
    ...
    if bot.guilds:
        ...
        try:
            from community.core.sync import arrange_with_guild
    ...
    try:
        from community.core.dev_agent import ensure_dev_seeded
    ...
    try:
        ...
        try:
            from community.scenes.tutorial.handlers import force_hana_greeting_if_missing
...
async def _check_owner_profile(guild):
    ...
    from community import db
    from community.core.profile import get_user_name, get_user_id
    ...
    # 유나 이름
    from community.core.profile import load_profile as _lp
