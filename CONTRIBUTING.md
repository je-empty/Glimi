...
처음이라면 **`docs/START_HERE.html`** (프로젝트 정체·셋업·첫 task) → **`docs/COLLAB_GUIDE.html`** (협업 규약 전체) 순서로.
...
4. **구역**: 콘텐츠 (catalog·씬) 는 자유, 코어 포함 나머지는 리뷰 필수, 인프라·시크릿은 메인테이너 전용 — 상세는 `docs/COLLAB_GUIDE.html` §1.
