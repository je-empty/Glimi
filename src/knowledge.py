...
def _resolve_achievements(agent_id: str) -> str:
    ...
    from src.achievements.definitions import ACHIEVEMENTS
...
def _resolve_my_tools(agent_id: str) -> str:
    ...
    from src.core.tools.registry import tools_for_agent
