...
def formatting_guide(agent_type: str = "persona") -> str:
    ...
    Platform decoupling: 이전엔 `src.bot.formatting` 에서 import 하는 소프트 누수였으나
    `src.core.formatting` 으로 이동됨 (Phase 2-C)."""
    try:
        from src.core.formatting import get_formatting_guide
